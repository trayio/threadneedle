  ...
  threadneedle[methodName] = function (params) {
    ...
    */
    ...
    return when.promise(function (resolve, reject) {
      ...
      //     return globalize.afterSuccess.call(threadneedle, config, result.body, params, result.response);//.done(resolve, reject);
      //   },
      //   function (err) {
      ...
      //     return globalize.afterFailure.call(threadneedle, config, payload, params, response);//.done(reject, reject);
      //   }
      // )
      //
      // .done(resolve, reject);
