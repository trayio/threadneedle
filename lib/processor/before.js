...
module.exports = async function (methodBefore, globalBefore, params = {}) {
	...
	const returnedParamsValidator = referenceValidator(params);
	...
	const validatedParams = returnedParamsValidator(globalParamsResult) || params;

	const methodParamsResult = ( methodBefore ? await methodBefore(validatedParams) : validatedParams );

	return returnedParamsValidator(methodParamsResult) || validatedParams;
